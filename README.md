...
#### 1. Does Bitcoin's trading prices behavior more closely resemble that of a risky asset class or currency? 
 ...
 ![annualized returns](Images/annualized_returns.png)
 ![annualized std](Images/annualized_std.png)
...
#### 6. Which factors most signficantly affect investor sentiment on Bitcoin?
 ...
 Based on the api data from GlassNode we determined the following factors do influence the bitcoin prices.
