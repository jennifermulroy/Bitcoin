...
class apiservice:
    ...
    def get_supply(self,symbols,duration=sd.Current,from_date='',to_date='',frequency_interval='24h'):
        ...
        self.glassnode_api_url+=f'supply/{supply_endpoint}?api_key={self.api_key}&a={symbols}&i={frequency_interval}'
    ...
    def get_Transactions(self,symbols,transactiontype=tt.Transfers_Volume_Sum,from_date='',to_date='',frequency_interval='24h'):
        ...
        self.glassnode_api_url+=f'transactions/{transcation_endpoint}?api_key={self.api_key}&a={symbols}&i={frequency_interval}'
    ...
    def get_addresses(self,symbols,addresstype=adtype.Min_10k_Count,from_date='',to_date='',frequency_interval='24h'):
        ...
        self.glassnode_api_url+=f'addresses/{address_endpoint}?api_key={self.api_key}&a={symbols}&i={frequency_interval}'
